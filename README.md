...
This is an implementation of [Mask R-CNN](https://arxiv.org/abs/1703.06870) on Python 3, Keras, and TensorFlow. The model generates bounding boxes and segmentation masks for each instance of an object in the image. It's based on [Feature Pyramid Network (FPN)](https://arxiv.org/abs/1612.03144) and a [ResNet101](http://www.arxiv.org/abs/1512.03385) backbone.
